...
<script>
    var modalBorrar = document.getElementById('md_borrar_asig');
    modalBorrar.addEventListener('show.bs.modal', function(event){
        let boton = event.relatedTarget;
        let idasig = boton.getAttribute('data-id');
        modalBorrar.querySelector('.lbl_id_asig').textContent = "ID: " + idasig;
        modalBorrar.querySelector('.btn_confirmar_borrar').href = "borrar_asignacion.php?idasig=" + idasig;
    });
</script>
